                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" method="POST" action="index.php/admin/editProduct" id="formulario">

                                    <div class="col-lg-5">
                                           <div class="form-group">
                                                <label>Escoja el Modelo del Producto a Editar:</label>
                                                 <select name="modelo" id="selectmodelo" class="form-control">                   
                                                        <option  value=" " >Seleccione Modelo a Editar..</option>
