...
?>
  <div id="page-wrapper" >
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Eliminar Servicio</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" method="POST" action="index.php/admin/deleteService" id="formulario">

                                    <div class="col-lg-5">
                                           <div class="form-group">
                                                <label>Escoja el Nombre del Servicio a Eliminar:</label>
                                                 <select name="nombre" id="selectnombre" class="form-control">                   
                                                        <option  value=" " >Seleccione el Nombre a Eliminar..</option>
