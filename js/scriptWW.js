...
var Buscador={
	...
	fCharge:function(){
		...
		.done(function(i){
			Buscador.rows = JSON.parse(i);	
			for(x = 0 ;x <= Buscador.rows.length -1; x++){
				i = '<option value="0">Familia</option>';
				i += '<option value="'+Buscador.rows[x].id_o+'">'+Buscador.rows[x].descripcion+'</option>';
			}
			$('#i4').html(i);
		});
		...
		.done(function(i){
			Buscador.rows = JSON.parse(i);	
			for(x = 0 ;x <= Buscador.rows.length -1; x++){
			i = '<option value="0">SubCategor&iacute;a</option>';
				i += '<option value="'+Buscador.rows[x].id_o+'">'+Buscador.rows[x].descripcion+'</option>';
			}
			$('#i5').html(i);
		});
		...
		.done(function(i){
			Buscador.rows = JSON.parse(i);	
			for(x = 0 ;x <= Buscador.rows.length -1; x++){
				i = '<option value="0">Categor&iacute;a</option>';
				i += '<option value="'+Buscador.rows[x].id_o+'">'+Buscador.rows[x].descripcion+'</option>';
			}
			$('#i6').html(i);
		});
		...
		.done(function(i){
			Buscador.rows = JSON.parse(i);	
			i = '<option value="0">Aplicaci&oacute;n</option>';
			for(x = 0 ;x <= Buscador.rows.length -1; x++){
				i += '<option value="'+Buscador.rows[x].id_o+'">'+Buscador.rows[x].descripcion+'</option>';
			}
			$('#i7').html(i);
		...
		.done(function(i){
			Buscador.rows = JSON.parse(i);	
			for(x = 0 ;x <= Buscador.rows.length -1; x++){
				i = '<option value="0">L&iacute;nea</option>';
				i += '<option value="'+Buscador.rows[x].id_o+'">'+Buscador.rows[x].descripcion+'</option>';
			}
			$('#i8').html(i);
		});
